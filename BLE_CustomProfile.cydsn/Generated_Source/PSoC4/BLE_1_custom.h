...
#define CYBLE_CAPSENSE_SERVICE_HANDLE   (0x000Eu) /* Handle of Capsense service */
#define CYBLE_CAPSENSE_SLIDER_DECL_HANDLE   (0x000Fu) /* Handle of Slider characteristic declaration */
#define CYBLE_CAPSENSE_SLIDER_CHAR_HANDLE   (0x0010u) /* Handle of Slider characteristic */
#define CYBLE_CAPSENSE_SLIDER_SLIDERCCCD_DESC_HANDLE   (0x0011u) /* Handle of SliderCCCD descriptor */
