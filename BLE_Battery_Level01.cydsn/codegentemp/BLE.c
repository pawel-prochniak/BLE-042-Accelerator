...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    {0x02u, 0x00u, 0x00u, 0x50u, 0xA0u, 0x00u}, /* uint8* direct_addr */
...
{
    { 0x02u, 0x01u, 0x06u, 0x0Fu, 0x09u, 0x42u, 0x61u,
    0x74u, 0x74u, 0x65u, 0x72u, 0x79u, 0x20u, 0x4Cu, 0x65u,
    0x76u, 0x65u, 0x6Cu, 0x73u, 0x07u, 0x03u, 0x0Au, 0x18u,
    0x0Fu, 0x18u, 0x0Fu, 0x18u, 0x00u, 0x00u, 0x00u, 0x00u }, /* uint8 advertising_data[CYBLE_MAX_ADV_DATA_LEN] */
    0x1Bu,      /* uint8 adv_data_length */
};

CYBLE_GAPP_SCAN_RSP_DATA_T cyBle_scanRspData =
{
    { 0x0Fu, 0x09u, 0x42u, 0x61u, 0x74u, 0x74u, 0x65u,
    0x72u, 0x79u, 0x20u, 0x4Cu, 0x65u, 0x76u, 0x65u, 0x6Cu,
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0x02u, 0x00u, 0x00u, 0x50u, 0xA0u, 0x00u}, 0x00u };
