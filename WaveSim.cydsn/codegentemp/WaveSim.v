...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("d9fb55e9-c7ba-40c7-a818-17cac9f0296f/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__ConnectedLED_net;
	wire [0:0] tmpFB_0__ConnectedLED_net;
	wire [0:0] tmpIO_0__ConnectedLED_net;
	wire [0:0] tmpINTERRUPT_0__ConnectedLED_net;
	electrical [0:0] tmpSIOVREF__ConnectedLED_net;

	cy_psoc3_pins_v1_10
		#(.id("a79796c3-0839-40d7-9950-7478c8e7e1ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ConnectedLED
		 (.oe(tmpOE__ConnectedLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ConnectedLED_net[0:0]}),
		  .io({tmpIO_0__ConnectedLED_net[0:0]}),
		  .siovref(tmpSIOVREF__ConnectedLED_net),
		  .interrupt({tmpINTERRUPT_0__ConnectedLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ConnectedLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AdvLED_net;
	wire [0:0] tmpFB_0__AdvLED_net;
	wire [0:0] tmpIO_0__AdvLED_net;
	wire [0:0] tmpINTERRUPT_0__AdvLED_net;
	electrical [0:0] tmpSIOVREF__AdvLED_net;

	cy_psoc3_pins_v1_10
		#(.id("986d8cef-7330-4131-80b3-6c72f3b94fd1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AdvLED
		 (.oe(tmpOE__AdvLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AdvLED_net[0:0]}),
		  .io({tmpIO_0__AdvLED_net[0:0]}),
		  .siovref(tmpSIOVREF__AdvLED_net),
		  .interrupt({tmpINTERRUPT_0__AdvLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AdvLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
