...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Sin Wave service */
    {
        0x000Eu, /* Handle of the Sin Wave service */ 
        {

            /* Sin Wave Char characteristic */
            {
                0x0010u, /* Handle of the Sin Wave Char characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0011u, /* Handle of the SinCCCD descriptor */ 
                }, 
            },
        }, 
    },
