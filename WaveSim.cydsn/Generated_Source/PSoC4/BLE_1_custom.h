...
#define CYBLE_SIN_WAVE_SERVICE_INDEX   (0x00u) /* Index of Sin Wave service in the cyBle_customs array */
#define CYBLE_SIN_WAVE_SIN_WAVE_CHAR_CHAR_INDEX   (0x00u) /* Index of Sin Wave Char characteristic */
#define CYBLE_SIN_WAVE_SIN_WAVE_CHAR_SINCCCD_DESC_INDEX   (0x00u) /* Index of SinCCCD descriptor */


#define CYBLE_SIN_WAVE_SERVICE_HANDLE   (0x000Eu) /* Handle of Sin Wave service */
#define CYBLE_SIN_WAVE_SIN_WAVE_CHAR_DECL_HANDLE   (0x000Fu) /* Handle of Sin Wave Char characteristic declaration */
#define CYBLE_SIN_WAVE_SIN_WAVE_CHAR_CHAR_HANDLE   (0x0010u) /* Handle of Sin Wave Char characteristic */
#define CYBLE_SIN_WAVE_SIN_WAVE_CHAR_SINCCCD_DESC_HANDLE   (0x0011u) /* Handle of SinCCCD descriptor */
