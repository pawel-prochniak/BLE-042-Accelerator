...
#define CYBLE_SENSOR_X_CHAR_INDEX   (0x00u) /* Index of X characteristic */
#define CYBLE_SENSOR_X_SENSORCCCD_DESC_INDEX   (0x00u) /* Index of SensorCCCD descriptor */
#define CYBLE_SENSOR_Y_CHAR_INDEX   (0x01u) /* Index of Y characteristic */
#define CYBLE_SENSOR_Y_SENSORCCCD_DESC_INDEX   (0x00u) /* Index of SensorCCCD descriptor */
#define CYBLE_SENSOR_Z_CHAR_INDEX   (0x02u) /* Index of Z characteristic */
#define CYBLE_SENSOR_Z_SENSORCCCD_DESC_INDEX   (0x00u) /* Index of SensorCCCD descriptor */


#define CYBLE_SENSOR_SERVICE_HANDLE   (0x000Eu) /* Handle of Sensor service */
#define CYBLE_SENSOR_X_DECL_HANDLE   (0x000Fu) /* Handle of X characteristic declaration */
#define CYBLE_SENSOR_X_CHAR_HANDLE   (0x0010u) /* Handle of X characteristic */
#define CYBLE_SENSOR_X_SENSORCCCD_DESC_HANDLE   (0x0011u) /* Handle of SensorCCCD descriptor */
#define CYBLE_SENSOR_Y_DECL_HANDLE   (0x0012u) /* Handle of Y characteristic declaration */
#define CYBLE_SENSOR_Y_CHAR_HANDLE   (0x0013u) /* Handle of Y characteristic */
#define CYBLE_SENSOR_Y_SENSORCCCD_DESC_HANDLE   (0x0014u) /* Handle of SensorCCCD descriptor */
#define CYBLE_SENSOR_Z_DECL_HANDLE   (0x0015u) /* Handle of Z characteristic declaration */
#define CYBLE_SENSOR_Z_CHAR_HANDLE   (0x0016u) /* Handle of Z characteristic */
#define CYBLE_SENSOR_Z_SENSORCCCD_DESC_HANDLE   (0x0017u) /* Handle of SensorCCCD descriptor */
