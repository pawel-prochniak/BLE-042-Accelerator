    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'P', (uint8)'P', (uint8)'B', (uint8)'L', (uint8)'E', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[20] }, /* Alert Level */
    { 0x0001u, (void *)&cyBle_attValues[21] }, /* Battery Level */
    { 0x0007u, (void *)&cyBle_attValues[22] }, /* Characteristic Presentation Format */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x15u] = {
    ...
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd    */, 0x0015u, {{0x2A19u, NULL}}                           },
    { 0x0013u, 0x2A19u /* Battery Level                       */, 0x00000201u /* rd    */, 0x0015u, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0014u, 0x2904u /* Characteristic Presentation Format  */, 0x00000201u /* rd    */, 0x0014u, {{0x0007u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0015u, 0x2902u /* Client Characteristic Configuration */, 0x00000A04u /* rd,wr */, 0x0015u, {{0x0002u, (void *)&cyBle_attValuesLen[9]}} },
};
